...
class PenEnConfigModel(BaseModel):
    origins: List[str] = []
    log_file: str
...
def set_config(prog_name, loop, args=None):
    ...
    try:
        config = PenEnConfigModel.parse_obj(json.load(open(config_file)))
...
if __name__ == "__main__":
    ...
    m = PenEnConfigModel.parse_obj(conf)
    print(m)
